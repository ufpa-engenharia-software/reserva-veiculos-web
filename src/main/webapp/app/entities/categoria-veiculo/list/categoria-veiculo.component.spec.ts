...
describe('Component Tests', () => {
  describe('CategoriaVeiculo Management Component', () => {
    let comp: CategoriaVeiculoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CategoriaVeiculoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.categoriaVeiculos?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
