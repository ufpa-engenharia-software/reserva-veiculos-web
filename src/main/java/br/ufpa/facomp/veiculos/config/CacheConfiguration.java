package br.ufpa.facomp.veiculos.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.ufpa.facomp.veiculos.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.ufpa.facomp.veiculos.repository.UserRepository.USERS_BY_EMAIL_CACHE);
